...
test_dir("C:/Users/AARAS2/Downloads/NWT/modules/comm_metricsNWT/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/AARAS2/Downloads/NWT/modules/comm_metricsNWT/tests/testthat/test-template.R")
